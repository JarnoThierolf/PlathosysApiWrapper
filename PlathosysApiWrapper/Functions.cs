...
/* decorated function names from "dumpbin.exe /exports PlathosysApi.dll"

    ordinal hint RVA      name

          1    0 00001020 ?ApiVersionNumber@PlathosysFn@PlathosysApiFuncs@@SAIXZ
          2    1 00001280 ?Closedevice@PlathosysFn@PlathosysApiFuncs@@SAHXZ
          3    2 00001F00 ?InitHookAndPTTState@PlathosysFn@PlathosysApiFuncs@@SAHXZ
          4    3 00001010 ?IsDeviceOpen@PlathosysFn@PlathosysApiFuncs@@SAHXZ
          5    4 000029F0 ?MuteMicCt140@PlathosysFn@PlathosysApiFuncs@@SAH_N@Z
          6    5 00002AB0 ?MuteSpkCt140@PlathosysFn@PlathosysApiFuncs@@SAH_N@Z
          7    6 00001030 ?Opendevice@PlathosysFn@PlathosysApiFuncs@@SAHIIPAI0PAD1@Z
          8    7 00002B60 ?ReadCurrentInfo@PlathosysFn@PlathosysApiFuncs@@SAHPAE000000000@Z
          9    8 00002E70 ?ReadCurrentInfodB@PlathosysFn@PlathosysApiFuncs@@SAHPAE000000000PAD11110@Z
         10    9 00003590 ?ReadHookAndPTT@PlathosysFn@PlathosysApiFuncs@@SAHPAI@Z
         11    A 00002790 ?SetByListening@PlathosysFn@PlathosysApiFuncs@@SAH_N@Z
         12    B 00002830 ?SetCodecType@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         13    C 00002370 ?SetConference@PlathosysFn@PlathosysApiFuncs@@SAH_N@Z
         14    D 00002240 ?SetEchoCanseller@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         15    E 000022E0 ?SetExtMic@PlathosysFn@PlathosysApiFuncs@@SAH_N@Z
         16    F 00001CA0 ?SetExtMicVolume@PlathosysFn@PlathosysApiFuncs@@SAHI@Z
         17   10 00001D70 ?SetExtMicdBVolume@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         18   11 000026F0 ?SetExtmicLed@PlathosysFn@PlathosysApiFuncs@@SAH_N@Z
         19   12 00001A50 ?SetHandsetMicVolume@PlathosysFn@PlathosysApiFuncs@@SAHI@Z
         20   13 00001400 ?SetHandsetVolume@PlathosysFn@PlathosysApiFuncs@@SAHI@Z
         21   14 00002400 ?SetHeadsetActive@PlathosysFn@PlathosysApiFuncs@@SAH_N@Z
         22   15 00002650 ?SetHeadsetEar@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         23   16 00001AE0 ?SetHeadsetMicVolume@PlathosysFn@PlathosysApiFuncs@@SAHI@Z
         24   17 00001BB0 ?SetHeadsetMicdBVolume@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         25   18 00001490 ?SetHeadsetVolume@PlathosysFn@PlathosysApiFuncs@@SAHI@Z
         26   19 00001560 ?SetHeadsetdBVolume@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         27   1A 00001870 ?SetIntAlarmSpeakerVolume@PlathosysFn@PlathosysApiFuncs@@SAHI@Z
         28   1B 00001940 ?SetIntAlarmSpeakerdBVolume@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         29   1C 00001360 ?SetIntSpeakerMute@PlathosysFn@PlathosysApiFuncs@@SAH_N@Z
         30   1D 00001670 ?SetIntSpeakerVolume@PlathosysFn@PlathosysApiFuncs@@SAHI@Z
         31   1E 00001760 ?SetIntSpeakerdBVolume@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         32   1F 00003690 ?SetLyncFeature@PlathosysFn@PlathosysApiFuncs@@SAHI@Z
         33   20 00002060 ?SetMicMute@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         34   21 000025C0 ?SetPttFunctions@PlathosysFn@PlathosysApiFuncs@@SAHI@Z
         35   22 000028D0 ?SetSerialNumber@PlathosysFn@PlathosysApiFuncs@@SAHK@Z
         36   23 00001E60 ?SetSideTone@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         37   24 00002100 ?SetSpeakerOutMute@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         38   25 000021A0 ?SetWideBand@PlathosysFn@PlathosysApiFuncs@@SAHH@Z
         39   26 00002530 ?SetWirelessCall@PlathosysFn@PlathosysApiFuncs@@SAH_N@Z
         40   27 000024A0 ?SetWirelessHeadsetRinging@PlathosysFn@PlathosysApiFuncs@@SAH_N@Z
*/
